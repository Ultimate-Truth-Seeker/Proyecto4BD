...
class Command(BaseCommand):
    help = 'Crear las vistas SQL para el sistema de biblioteca'

    def handle(self, *args, **options):
        with connection.cursor() as cursor:
            # Vista 1: Catálogo de libros con información completa
            cursor.execute("""
            ...
            # Vista 2: Estado de préstamos y usuarios
            cursor.execute("""
            ...
            # Vista 3: Reporte de sucursales y actividad
            cursor.execute("""
        ...
        self.stdout.write(
            self.style.SUCCESS('Vistas creadas exitosamente!')
        )